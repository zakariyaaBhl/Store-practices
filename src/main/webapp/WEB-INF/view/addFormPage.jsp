      ...
      <nav class="navbar navbar-default">
		...
		<br>
			...
			<div class="panel-body">
					...
					<form:form method="POST" action="${pageContext.request.contextPath}/addProduct" cssClass="text-center" modelAttribute="prod">
					  <div class="form-group text-center">
					    <label for="designation">Désignation : </label>
					    <form:errors path="designation" cssClass="error text-danger" />
					    <input type="text" class="form-control text-center" id="designation" name="designation" placeholder="designation" value="${product.designation}">
					  </div>
					  ...
					  <div class=" form-group text-right">
					  	 <button type="submit" class="btn btn-success btn-block" style="width: 50%;margin: 0 auto;">Add New Product</button>
